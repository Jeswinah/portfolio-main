  ...
  const projects = [
    {
      ...
      tags: ["React", "Express", "APIs","Authentication"],
    ...
    },
    {
      ...
      description:
        "A Netflix login clone for beginners is a simple web page that replicates the Netflix login interface using HTML, CSS, and basic JavaScript with a styled background and logo to mimic the original design",
    ...
    },
    {
      title: "Portfolio",
      description:
        "The completed portfolio website effectively showcases my development skills and projects, providing a professional online presence. This project highlights my ability to design and develop a modern, responsive website.",
    ...
    },
    {
      title: "To-do list",
      description:
        "I designed a clean and minimalist to-do list application interface using java script. This design balances functionality with simplicity, focusing on creating an and user-friendly task management task",
      tags: ["HTML", "CSS", "JavaScript"],
...

    {
      title: "Mini Calender",
      description:
        "Effortlessly manage your schedule with our sleek, mini calendar – big convenience in a compact design.",
      tags: ["HTML", "CSS", "JavaScript"],
    ...
    },
    {
      ...
      description:
        "The Pinterest signup page project is a static web page designed to mimic the original signup interface of Pinterest.",
      tags: ["HTML", "CSS", "JavaScript"],
